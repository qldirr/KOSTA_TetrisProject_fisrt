...
$(function(){
    ...
    var currentSeconds =  addZeros(currentDate.getSeconds(),2);
    	...
    	date.innerHTML = currentDate.getFullYear() + "년 " + (currentDate.getMonth()+1) + "월 " + currentDate.getDate() + "일";
...
function startDate(){
	 ...
	 if(confirm('출근하시겠습니까?')){
		alert('출근하셨습니다');
		startTime.innerHTML = currentHours+":"+currentMinute+":"+currentSeconds;
	}
}
function endDate(){
	var currentDate = new Date();
	...
	if(confirm('퇴근하시겠습니까?')){
		alert('퇴근하셨습니다');
		endTime.innerHTML = currentHours+":"+currentMinute+":"+currentSeconds;
	}
} 	
...
<div>
	<div id="date"></div>
	<!-- 시계 -->
	<div style=" width:200px; height: 80px; line-height:80px; color:#666;font-size:40px; text-align:center;" id="clock"></div>
		<!-- 출근시간 -->
