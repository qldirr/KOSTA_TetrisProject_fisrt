...
<h1>${pj_num } 새 업무 생성</h1>
	...
	<form action="/projectdetail/registerTask" method="post" accept-charset="UTF-8">
		<input type="hidden" name="pj_num" value="${pj_num }">
		업무명: <input type="text" name="ts_name"><br> 
		업무내용: <input type="text" name="ts_contents"><br>
		업무시작일: <input id="datePickerstart" type="text" name="ts_startdate"><br> 
		업무마감일: <input id="datePickerend" type="text" name="ts_enddate"><br>
		업무상태: 
		<select name="ts_status" id="selectStatus">
			<option value="예정">예정</option>
			<option value="진행">진행중</option>
			<option value="완료">완료</option>
		</select><br>
		업무중요도: 
		<input type="radio" name="ts_importance" value="상"> 상
		<input type="radio" name="ts_importance" value="중"> 중
		<input type="radio" name="ts_importance" value="하"> 하
		<br>
		...
		<br>
		<input type="submit" value="새 업무 생성">
